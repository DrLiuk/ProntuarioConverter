...
def crea_larghezzaFrame(frame,listBox,id):
    mainWindow_larghezzaFrame = Frame(frame,background=color_window_left_frame)
    mainWindow_larghezzaFrame.pack(pady=20)
    larghezza = StringVar()
    ...
    larghezzaEntry.pack()
    #larghezzaEntry.bind('<<KeyPress>>',aggiorna_listBox(listBox,id + larghezza.get()))
    return larghezza

def crea_altezzaFrame(frame,listBox,id):
    mainWindow_altezzaFrame = Frame(frame,background=color_window_left_frame)
    mainWindow_altezzaFrame.pack(pady=20)
    altezza = StringVar()
    ...
    altezzaEntry.pack()
    #altezzaEntry.bind('<KeyRelease>',aggiorna_listBox(listBox,id[0] + altezza.get()))
    return altezza

def crea_spessoreFrame(frame,listBox,id):
    mainWindow_spessoreFrame = Frame(frame,background=color_window_left_frame)
    mainWindow_spessoreFrame.pack(pady=20)
    spessore = StringVar()
    ...
    spessoreEntry.pack()
    #spessoreEntry.bind('<KeyRelease>',aggiorna_listBox(listBox,id[0] + spessore.get()))
    return spessore

def crea_diametroFrame(frame,listBox,id):
    ...
    diametroEntry.pack()
    #diametroEntry.bind('<KeyRelease>',aggiorna_listBox(listBox,id[0] + diametro.get()))
    return diametro
